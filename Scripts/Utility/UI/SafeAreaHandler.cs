...
namespace HungNT
{
    ...
    public class SafeAreaHandler : MonoBehaviour
    {
        ...
        [SerializeField] bool ForceBottomZero = false; //Some case we want safe area ignore bottom
...
#if UNITY_EDITOR
        // Update Safe Area in Editor Mode
        private void OnEnable()
        {
            EditorApplication.update += RefreshInEditor;
        }
