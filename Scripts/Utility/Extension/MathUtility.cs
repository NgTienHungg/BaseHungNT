...
namespace HungNT
{
    ...
    {
        public static float RandomValue(Vector2 range) => UnityEngine.Random.Range(range.x, range.y);
        public static int RandomValue(Vector2Int range) => UnityEngine.Random.Range(range.x, range.y);
        public static int RandomValue(int from, int to) => UnityEngine.Random.Range(from, to);
        public static float RandomValue(float from, float to) => UnityEngine.Random.Range(from, to);
        ...
        public static TObject GetRandomArrayElement<TObject>(TObject[] array)
        {
